...
import { MockAppLoaderForm, MockNgxLoadingBarComponent, MockNotificationComponent, MockOcToastsComponent } from '../mock/components.mock';
...
describe('AppComponent', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            declarations: [AppComponent, MockNgxLoadingBarComponent, MockNotificationComponent, MockAppLoaderForm, MockOcToastsComponent],
